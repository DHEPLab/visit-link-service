...
public class ProjectService {
    ...
    public ProjectService(ProjectRepository repository, PasswordEncoder passwordEncoder, UserRepository userRepository) {
    ...
    public ResponseEntity createProject(ProjectDTO projectDTO) {
        ...
        repository.save(project);
        ProjectCreateResultDTO projectCreateResult = ProjectCreateResultDTO.builder().projectId(project.getId()).username(admin.getUsername())
                .password(originPsw).build();
