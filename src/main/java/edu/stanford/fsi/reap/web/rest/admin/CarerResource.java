...
public class CarerResource {
    ...
    public CarerResource(CarerRepository repository, CarerService service, ModelMapper modelMapper,
                         CarerModifyRecordRepository carerModifyRecordRepository, UserRepository userRepository,
        ...
        if (repository.findById(id).isPresent()) {
            ...
            try {
                ...
                if (!(differentColumns.isEmpty())) {
                    ...
                    carerModifyRecordRepository.save(new CarerModifyRecord(null, SecurityUtils.getUserId(), carer.getId(), oldCarer, carer, differentColumnsStr));
                }
