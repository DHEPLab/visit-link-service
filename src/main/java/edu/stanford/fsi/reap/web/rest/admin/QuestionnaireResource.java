...
public class QuestionnaireResource {
  ...
  public QuestionnaireResource(QuestionnaireRepository questionnaireRepository, QuestionnaireService questionnaireService, ModelMapper modelMapper, LessonRepository lessonRepository) {
   ...
   */
  @PostMapping
  public void publishQuestionnaire(@Valid @RequestBody QuestionnaireRequestDTO questionnaireRequestDTO) {
   ...
   */
  @PostMapping("/draft")
  public void saveQuestionnaireDraft(@Valid @RequestBody QuestionnaireRequestDTO questionnaireRequestDTO) {
    Questionnaire questionnaire = modelMapper.map(questionnaireRequestDTO, Questionnaire.class);
  ...
  @GetMapping
  public Page<QuestionnaireResultDTO> getQuestionnaires(@RequestParam(defaultValue = "") String name, Pageable pageable) {
