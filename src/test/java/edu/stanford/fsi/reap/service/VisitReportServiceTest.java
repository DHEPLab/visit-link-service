...
class VisitReportServiceTest {
    ...
    public static void beforeAll() throws JsonProcessingException {
        ...
        QuestionnaireRecordRepository questionnaireRecordRepository = mock(QuestionnaireRecordRepository.class);
    ...
    public void should_sort() {
        List<VisitReportObjData> expectedList = Collections.singletonList(new VisitReportObjData(null, null, null,
                Arrays.asList(
        ...
        List<VisitReportObjData> list = Collections.singletonList(new VisitReportObjData(null, null, null,
                        Arrays.asList(
                                new QuestionnaireRecord(3L, "张三3", "answer3", "11", null),
                                new QuestionnaireRecord(2L, "张三2", "answer2", "2", null),
                                new QuestionnaireRecord(4L, "张三4", "answer4", "12", null),
