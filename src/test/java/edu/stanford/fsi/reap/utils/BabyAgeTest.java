...
class BabyAgeTest {
  ...
  public void should_past_edc() {
    assertTrue(BabyAge.pastEdc(BabyStage.EDC, LocalDate.of(2020, 1, 1), LocalDate.of(2020, 1, 2)));
  }

  @Test
  public void should_not_past_edc() {
    assertFalse(
        BabyAge.pastEdc(BabyStage.BIRTH, LocalDate.of(2020, 1, 1), LocalDate.of(2020, 1, 2)));
    assertFalse(BabyAge.pastEdc(BabyStage.EDC, LocalDate.of(2020, 1, 1), LocalDate.of(2020, 1, 1)));
  }
}
